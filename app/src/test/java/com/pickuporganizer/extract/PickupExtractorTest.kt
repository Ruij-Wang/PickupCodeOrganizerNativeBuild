...
class PickupExtractorTest {
    ...
    fun extractsPlannedExample() {
        val result = PickupExtractor.extract(
            rawText = "您的京东快递已到132号中山大学明德园6号菜鸟驿站京东点，请凭提货号6-2230前往领取",
            packageName = "com.jingdong.app.mall"
        )

        assertEquals("京东", result.appSource)
        assertEquals("6-2230", result.pickupCode)
        assertEquals("132号中山大学明德园6号菜鸟驿站京东点", result.station)
    ...
    fun extractsThirtyCommonNotificationSamples() {
        val samples = listOf(
            Sample("您的京东包裹已到菜鸟驿站中山大学明德园店,凭取件码A12345领取", "com.jingdong.app.mall", "京东", "A12345"),
            Sample("菜鸟提醒: 包裹已到中大明德园6号菜鸟驿站,取件码 8-0091", "com.cainiao.wireless", "菜鸟", "8-0091"),
            ...
            Sample("京东物流: 已到明德园京东点,货架号 JD9981", "com.jingdong.app.mall", "京东", "JD9981"),
            ...
            Sample("您的包裹已放至明德园6号菜鸟驿站,编号 102938", "com.cainiao.wireless", "菜鸟", "102938"),
            Sample("快递到达中山大学快递柜,凭取货码 7-8888 开柜", "com.android.mms", "短信", "7-8888"),
            Sample("京东快递已到西门京东点，提货码：JD-7788", "com.jingdong.app.mall", "京东", "JD-7788"),
            Sample("菜鸟裹裹: 包裹到达明德园妈妈驿站,凭码 1-2233", "com.cainiao.wireless", "菜鸟", "1-2233"),
            ...
            Sample("京东快递到达中山大学菜鸟驿站，请凭编号 778899 领取", "com.jingdong.app.mall", "京东", "778899"),
